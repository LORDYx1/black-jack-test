...
function renderGame() {
    ...
    if (roundOver === true) {
        betBn1.style.backgroundColor = 'rgb(229, 255, 0)'
        betBn2.style.backgroundColor = 'rgb(229, 255, 0)'
        betBn3.style.backgroundColor = 'rgb(229, 255, 0)'
        betBn4.style.backgroundColor = 'rgb(229, 255, 0)'
        ...
        hitBtn.style.backgroundColor = 'rgb(229, 255, 0)'
        standBtn.style.backgroundColor = 'rgb(229, 255, 0)'
        if (playerHand.length === 2) { //Only activate the Double Down button if the player is on their first turn
            doubleBtn.style.backgroundColor = 'rgb(229, 255, 0)'
        } else {
            doubleBtn.style.backgroundColor = 'darkgray'
        }
    }
